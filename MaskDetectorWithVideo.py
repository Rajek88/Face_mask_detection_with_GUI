...
if __name__ == "__main__":
    ...
    parser.add_argument('--video-path', type=str, default=vpath, help='')
    ...
    if args.img_mode:
        ...
        cv2.namedWindow('MaskDetection in Video', cv2.WINDOW_NORMAL)
        cv2.imshow('MaskDetection in Video', result[:,:,::-1])
        cv2.waitKey(0)
        cv2.destroyAllWindows()
    else:
