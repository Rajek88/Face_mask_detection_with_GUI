...
if __name__ == "__main__":
    ...
    parser.add_argument('--img-path', type=str, default=ipath, help='path to your image.')
    ...
    if args.img_mode:
        ...
        cv2.namedWindow('MaskDetection in Photo', cv2.WINDOW_NORMAL)
        cv2.imshow('MaskDetection in Photo', result[:,:,::-1])
        cv2.waitKey(0)
        cv2.destroyAllWindows()
    else:
        ...
        if args.img_path == '0':
            img_path = 0
        run_on_video(Net, img_path, conf_thresh=0.5)
